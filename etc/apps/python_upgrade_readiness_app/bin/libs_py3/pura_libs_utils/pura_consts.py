...
SKYNET_LOG_DIR = os.path.join(PURA_LOG_DIR, 'skynet')
...
CSV_PATH = os.path.join(APP_DIR, 'python_upgrade_readiness_app', 'bin', 'libs_py3', 'pura_libs_utils')
...
SKYNET_SCAN_SUMMARY_FILE = 'jura_scan_summary.json'
...
EMERALD_REQUIRED_ACTION_SPLUNKBASE = "Ask the admin/developer to update the app or uninstall the app."
...
MESSAGE_SUCCESS_EMAIL_SWITCH_UPDATE = "Successfully updated the email notification preferences {} on host {}."
