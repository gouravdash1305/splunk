...
from spacebridgeapp.util.constants import SPACEBRIDGE_APP_NAME, SEARCHES_COLLECTION_NAME, \
    ...
    SPLUNK_SESSION_TOKEN_TYPE, CLIENT_SUBSCRIBE_GENERIC_MESSAGE, SUBSCRIPTION_CREDENTIAL_GLOBAL, TRELLISENABLED
...
async def process_subscribe_udf_datasource(request_context: RequestContext,
    ...
    search_key = generate_search_hash(dashboard_id, datasource_id, input_tokens,
...
async def process_subscribe_dashboard_visualization_request(request_context: RequestContext,
    ...
    if True or dashboard_visualization_subscribe.HasField(TRELLISENABLED):
...
async def lazy_load_subscription_search(request_context, input_tokens, search_key,
                                        ...
                                        shard_id, spawn_search_job,
                                        dashboard_defn=None, dashboard_id=None,
                                        default_input_tokens=None, visualization_type=None,
                                        trellis_enabled=False, trellis_split_by=None):
    """
